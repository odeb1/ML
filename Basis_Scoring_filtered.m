function[label, Adash]=Basis_Scoring_filtered(y, mean, prevlabel)


addpath('fdaM')
load('FPCA_for_VibrationSurvey','vibration');
...
%Regularise time series      
        ...
        [fast_recy, fast_sq_error, fast_msq_error]=Reconstruct_n1(timeseries,fast_mu,fast_eig1,fast_eig2,fast_eig3,fast_eig4);
                    ...
                    %}
                        ...
                        n4=n;
                        [~, n, al1, al2]=template_Needleman(model5,mean);
                        n5=n;
                        ...
                        [~, n, ~, ~]=Needleman(model1,mean);
                        n1=n;
                        [~, n, ~, ~]=Needleman(model2,mean);
                        n2=n;
                        [~, n, ~, ~]=Needleman(model3,mean);
                        n3=n;
                        [~, n, ~, ~]=Needleman(model4,mean);
                        n4=n;
                        [~, n, al1, al2]=Needleman(model5,mean);
                        n5=n;
                        [~, n, ~, ~]=Needleman(model6,mean);
                        n6=n;
                        A=[n1 n2 n3 n4 n5 n6];
                        ...
                        label=Decision_Tree_filtered(Adash);
                        %{
                        if label==5
                            fprintf('alignment %d\n',al1);
                            fprintf('alignment %d\n',al2);
